  ...
  return (
    <div className="pt-16 lg:pt-24 relative overflow-hidden bg-[#fcf0e3]" id="celebration">
      ...
      <div className="gap-6 relative">
        <div className="z-10 relative max-w-desktop w-[90%] md:w-3/4 lg:w-[750px] mx-auto flex items-center text-center justify-center md:px-10 pt-10 pb-16 lg:pb-24 md:pt-16">
